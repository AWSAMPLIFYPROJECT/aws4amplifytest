...
<body>
  ...
  <div class="hero_area" style="background-image:url('../images/bkgrd.webp'); background-repeat: no-repeat; background-size: cover;">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="">Staff/ Admin</a>
              </li>
              <li class="nav-item">
...
<!-- end header section -->
<!-- book section -->
<section class="book_section layout_padding" style='margin-left:100px;'>
    <div class="container">
      <div class="heading_container">
        <h2>
            Comprehensive Attandance Lists
        </h2>
      </div>
      <div class="viewTb">
        <div class="col-md-6">
