...
try {
          ...
          $handler = new QRCodeManager();
            if(isset($_POST['reg'])){
            $status = $handler->enrolStaff();
       
            if($status ===1 ){ echo "<p class='text-success text-center'>Registration is successful.</p>";}
            ...
            <form action="" method="post">
             <div>
              <label class="myLabel">Firstname</label>
                <input type="text" name="firstname" class="form-control" placeholder="Enter First Name" value="<?php if(isset($_POST['firstname'])){ echo $_POST['firstname']; } ?>" />
              </div>
              <div>
              <label class="myLabel">Lastname</label>
                <input type="text" name="lastname" class="form-control" placeholder="Enter Last Name" value="<?php if(isset($_POST['lastname'])){ echo $_POST['lastname']; } ?>" />
              </div>
              <div>
              <label class="myLabel">Email</label>
                <input type="email" name="email" class="form-control" placeholder="Enter School Email"  value="<?php if(isset($_POST['email'])){ echo $_POST['email']; } ?>" />
              </div>
              <div>
              ...
              <div>
              <label class="myLabel">Qualification</label>
                <input type="text" name="qualification" class="form-control" placeholder="What is your Qualification" value="<?php if(isset($_POST['qualification'])){ echo $_POST['qualification']; } ?>" />
              </div>
              <div>
              <label class="myLabel">Specialisation</label>
                <input type="text" name="specialisation" class="form-control" placeholder="Enter area of specialty" value="<?php if(isset($_POST['specialisation'])){ echo $_POST['specialisation']; } ?>" />
              </div>
              <div>
              <label class="myLabel">Department</label>
                <input type="text" name="department" class="form-control" placeholder="Enter Department" value="<?php if(isset($_POST['department'])){ echo $_POST['department']; } ?>" />
              </div>
              <div>
              <label class="myLabel">Rank</label>
                <input type="text" name="rank" class="form-control" placeholder="Enter Rank" value="<?php if(isset($_POST['rank'])){ echo $_POST['rank']; } ?>" />
              </div>
              <div class="btn_box">
                <button name='reg'> Sign up  </button>
                <p style="color: #fff">
                  Already have account? <a  href="staffSignIn.php" style="color:rgb(243, 205, 102)">Sign In</a>
                </p>
              </div>
            </form>
          </div>
